      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex justify-between h-20 items-center">
                  ...
                  <Tooltip key={item.href}>
                    <TooltipTrigger asChild>
                      <Link
                        href={item.href}
                        className={cn(
                          "group inline-flex items-center px-3 py-2 text-xs font-bold transition-all relative whitespace-nowrap rounded-xl hover:bg-gray-50 cursor-pointer",
          ...
          <div className="hidden lg:flex lg:items-center gap-4 flex-shrink-0 ml-6">
            <Link href="/dashboard/profile" className="flex items-center gap-3 px-4 py-2 bg-gray-50 rounded-2xl border border-gray-100 hover:border-primary/20 transition-colors group cursor-pointer">
            ...
            <Tooltip>
              <TooltipTrigger asChild>
                <Button variant="ghost" size="icon" onClick={logout} className="text-gray-400 hover:text-primary hover:bg-primary/5 transition-all rounded-xl h-10 w-10 cursor-pointer">
          ...
          <div className="flex items-center lg:hidden">
            <Button variant="ghost" size="icon" onClick={() => setMobileMenuOpen(!mobileMenuOpen)} className="text-primary cursor-pointer">
          ...
          <div className="p-4 space-y-2">
            {filteredNavItems.map((item) => (
              <Link
                ...
                className={cn(
                  "flex items-center px-4 py-3 rounded-xl text-base font-bold cursor-pointer",
            ...
            <div className="pt-4 border-t mt-4">
              <Button variant="destructive" className="w-full justify-start h-12 rounded-xl font-bold cursor-pointer" onClick={logout}>
