  ...
  return (
    <div className="flex flex-col items-center justify-center min-h-screen p-4 bg-background">
      ...
      <div className="w-full max-w-md space-y-4">
        <Link href="/attendance/scan" className="block w-full">
          <Button variant="outline" className="w-full h-16 rounded-2xl border-2 border-primary text-primary hover:bg-primary hover:text-white font-black text-lg gap-3 transition-all group shadow-xl">
            <QrCode className="w-7 h-7 group-hover:scale-110 transition-transform" />
            Escanear Carnet Institucional
          </Button>
        </Link>

        <Card className="shadow-2xl border-t-4 border-t-primary bg-white rounded-3xl overflow-hidden">
