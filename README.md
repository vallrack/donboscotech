...
4. Añade una nueva variable:
   - Key: `RESEND_API_KEY`
   - Value: `re_vQmMKAsk_JpfmPSBDVNWwoA9k3PxvhfL8`
5. Realiza un nuevo despliegue (Redeploy).

## Automatización (Cron Jobs)
El sistema incluye una ruta para recordatorios automáticos:
`/api/cron/reminders`

Puedes configurar un **Vercel Cron Job** para que llame a esta URL cada 30 minutos. Esto enviará correos automáticamente a los docentes que no hayan marcado su entrada, incluso si no han iniciado sesión.
